...
## [0.0.35](https://github.com/dumko2001/deepagents/compare/deepagents-cli==0.0.34...deepagents-cli==0.0.35) (2026-03-19)


### Features

* **cli,sdk:** compaction hook ([#1420](https://github.com/dumko2001/deepagents/issues/1420)) ([e87cdad](https://github.com/dumko2001/deepagents/commit/e87cdaddb9a984c4fd189b4f71303881edb32cb2))
* **cli:** `--acp` mode to run CLI agent as ACP server ([#1297](https://github.com/dumko2001/deepagents/issues/1297)) ([c9ba00a](https://github.com/dumko2001/deepagents/commit/c9ba00a56b7ee5e48b56b13f9f093bb8bf639700))
* **cli:** `--json` flag for machine-readable output ([#1768](https://github.com/dumko2001/deepagents/issues/1768)) ([6f62496](https://github.com/dumko2001/deepagents/commit/6f62496bb699dfa6086ee1850b83f38d3b1242fa))
* **cli:** `/compact` command ([#1579](https://github.com/dumko2001/deepagents/issues/1579)) ([46e9e95](https://github.com/dumko2001/deepagents/commit/46e9e950087e973175d49d6a863cfa9d2f241528))
* **cli:** `/reload` command for in-session config refresh ([#1722](https://github.com/dumko2001/deepagents/issues/1722)) ([381aee6](https://github.com/dumko2001/deepagents/commit/381aee6d223fe3d866bedfe3a534916f419a4435))
* **cli:** `/threads` command switcher ([#1262](https://github.com/dumko2001/deepagents/issues/1262)) ([45bf38d](https://github.com/dumko2001/deepagents/commit/45bf38d7c5ca7ca05ec58c320494a692e419b632)), closes [#1111](https://github.com/dumko2001/deepagents/issues/1111)
* **cli:** add `--model-params` flag to `/model` command ([#1679](https://github.com/dumko2001/deepagents/issues/1679)) ([9b6433d](https://github.com/dumko2001/deepagents/commit/9b6433d557e6e8b3d39c10577595b0ef6d741c94))
* **cli:** add `--profile-override` CLI flag ([#1605](https://github.com/dumko2001/deepagents/issues/1605)) ([1984099](https://github.com/dumko2001/deepagents/commit/1984099ae9ac4b0c13dc08722abb9d56055da7b7))
* **cli:** add `--shell-allow-list all` ([#1695](https://github.com/dumko2001/deepagents/issues/1695)) ([4aec7b3](https://github.com/dumko2001/deepagents/commit/4aec7b35caa7723b8bbda189c9ca1d213e0a9a6d))
* **cli:** add `-n` short flag for `threads list --limit` ([#1731](https://github.com/dumko2001/deepagents/issues/1731)) ([8bbace9](https://github.com/dumko2001/deepagents/commit/8bbace9facd1e33757521e835dcb291accd2fa91))
* **cli:** add `-y` and `-S` short flags for auto-approve and shell-allow-list ([#1919](https://github.com/dumko2001/deepagents/issues/1919)) ([1036b16](https://github.com/dumko2001/deepagents/commit/1036b16276d59d8be669d963901c91aeb8cc2236))
* **cli:** add `/changelog`, `/feedback`, `/docs` ([#1261](https://github.com/dumko2001/deepagents/issues/1261)) ([4561afb](https://github.com/dumko2001/deepagents/commit/4561afbea17bb11f7fc02ae9f19db15229656280))
* **cli:** add `/trace` command to open LangSmith thread, link in switcher ([#1291](https://github.com/dumko2001/deepagents/issues/1291)) ([fbbd45b](https://github.com/dumko2001/deepagents/commit/fbbd45b51be2cf09726a3cd0adfcb09cb2b1ff46))
* **cli:** add `ask_user` tool for interactive agent questions ([#1377](https://github.com/dumko2001/deepagents/issues/1377)) ([de7068d](https://github.com/dumko2001/deepagents/commit/de7068d21fd4b932c6e53f500b0ea3b02a04c0aa))
* **cli:** add `enabled` flag to hide providers from `/model` switcher ([#1897](https://github.com/dumko2001/deepagents/issues/1897)) ([72a216c](https://github.com/dumko2001/deepagents/commit/72a216c88f661f9e53eaf92aedce40fac7b76d3c))
* **cli:** add `langchain-openrouter` ([#1340](https://github.com/dumko2001/deepagents/issues/1340)) ([5b35247](https://github.com/dumko2001/deepagents/commit/5b35247b126ed328e9562ac3a3c2acd184b39011))
* **cli:** add `litellm` optional dep ([#1818](https://github.com/dumko2001/deepagents/issues/1818)) ([defa21b](https://github.com/dumko2001/deepagents/commit/defa21bc6eea596bc67e70372e022d5b78049c0d))
* **cli:** add `sessions` as hidden keyword alias for `/threads` ([#1823](https://github.com/dumko2001/deepagents/issues/1823)) ([ffa98cc](https://github.com/dumko2001/deepagents/commit/ffa98ccf9ebe12eadb7f0e95f278dd9bd8eca240))
* **cli:** add animated spinner to non-interactive verbose mode ([#2001](https://github.com/dumko2001/deepagents/issues/2001)) ([153f465](https://github.com/dumko2001/deepagents/commit/153f465937c09a792119a0e0c8656fa8df29d4e5))
* **cli:** add background PyPI update check ([#1648](https://github.com/dumko2001/deepagents/issues/1648)) ([2e7a5e7](https://github.com/dumko2001/deepagents/commit/2e7a5e7d97f64147ab2d000fae833fe681f1d6b2))
* **cli:** add baseten as a model provider ([#1819](https://github.com/dumko2001/deepagents/issues/1819)) ([e05ee66](https://github.com/dumko2001/deepagents/commit/e05ee66b0d6c5cb996208d554686fc128f1094a2))
* **cli:** add curl-pipe-bash install script ([#1649](https://github.com/dumko2001/deepagents/issues/1649)) ([68f6ef9](https://github.com/dumko2001/deepagents/commit/68f6ef96e7d66b2c98d1371e91e5d25f107b80fe))
* **cli:** add drag-and-drop image attachment to chat input ([#1386](https://github.com/dumko2001/deepagents/issues/1386)) ([cd3d89b](https://github.com/dumko2001/deepagents/commit/cd3d89b4419b4c164915ff745afff99cb11b55a5))
* **cli:** add external editor support via `ctrl+x` and `/editor` ([#1861](https://github.com/dumko2001/deepagents/issues/1861)) ([bf5d088](https://github.com/dumko2001/deepagents/commit/bf5d088d4b3cee6c7e44c3abe3736f9972897896))
* **cli:** add fuzzy search to model switcher ([#1266](https://github.com/dumko2001/deepagents/issues/1266)) ([a6bbb18](https://github.com/dumko2001/deepagents/commit/a6bbb182a2336ba748d93a06b9fcf27966321e20))
* **cli:** add hook dispatch for external tool integration ([#1553](https://github.com/dumko2001/deepagents/issues/1553)) ([cdb2230](https://github.com/dumko2001/deepagents/commit/cdb2230f04ce7a2b7ef0837cbbc223dcbf04b78e))
* **cli:** add model profile overrides to config ([#1603](https://github.com/dumko2001/deepagents/issues/1603)) ([d3d6899](https://github.com/dumko2001/deepagents/commit/d3d6899209b7cf97447da0eee642b3f55261ffbc))
* **cli:** add model usage stats display ([#1587](https://github.com/dumko2001/deepagents/issues/1587)) ([a1208db](https://github.com/dumko2001/deepagents/commit/a1208db096761eb54e0fe712a5aa922502575cb6))
* **cli:** add nvidia api key support and default model ([#1577](https://github.com/dumko2001/deepagents/issues/1577)) ([9ce2660](https://github.com/dumko2001/deepagents/commit/9ce2660a67c3497cff18d27131fb7ef49e85b310))
* **cli:** add rotating tips to welcome banner ([#1898](https://github.com/dumko2001/deepagents/issues/1898)) ([d882ca8](https://github.com/dumko2001/deepagents/commit/d882ca81e2c9a11768a07824fd5b5ce8579bdcd7))
* **cli:** add sandbox type to trace metadata ([#1845](https://github.com/dumko2001/deepagents/issues/1845)) ([59ef941](https://github.com/dumko2001/deepagents/commit/59ef94143fc0adabb5f70f308527d98aa1511e44))
* **cli:** add single-click link opening for rich-style hyperlinks ([#1433](https://github.com/dumko2001/deepagents/issues/1433)) ([ef1fd31](https://github.com/dumko2001/deepagents/commit/ef1fd3115d77cd769e664d2ad0345623f9ce4019))
* **cli:** add skill deletion command ([#580](https://github.com/dumko2001/deepagents/issues/580)) ([40a8d86](https://github.com/dumko2001/deepagents/commit/40a8d866f952e0cf8d856e2fa360de771721b99a))
* **cli:** add sort, branch filter, and verbose flags to threads list ([#1732](https://github.com/dumko2001/deepagents/issues/1732)) ([11dc8e3](https://github.com/dumko2001/deepagents/commit/11dc8e3397ef9e9dbe8b15578e9258544ed6b452))
* **cli:** add substring matching to command history navigation ([#1301](https://github.com/dumko2001/deepagents/issues/1301)) ([e276d5a](https://github.com/dumko2001/deepagents/commit/e276d5a64bee9394f53ab993b01447023bcd4c7d))
* **cli:** add token breakdown to `/tokens` and simplify `/compact` messages ([#1782](https://github.com/dumko2001/deepagents/issues/1782)) ([2f37bff](https://github.com/dumko2001/deepagents/commit/2f37bffa9d7a9ced6945abe4ab6bc3409bfb97b1))
* **cli:** add video support to multimodal inputs ([#1521](https://github.com/dumko2001/deepagents/issues/1521)) ([f9b49b7](https://github.com/dumko2001/deepagents/commit/f9b49b7341bd42b5278a03496743e4709689598e))
* **cli:** add visual mode indicators to chat input ([#1371](https://github.com/dumko2001/deepagents/issues/1371)) ([1ea6159](https://github.com/dumko2001/deepagents/commit/1ea6159b068b8c7d721d90a5c196e2eb9877c1c5))
* **cli:** client-server architecture via `langgraph dev` ([#1759](https://github.com/dumko2001/deepagents/issues/1759)) ([f5407e6](https://github.com/dumko2001/deepagents/commit/f5407e6300e6ee51d8c88f1f183dd960b30a5b56))
* **cli:** defer HITL approval menu while user is typing ([#1833](https://github.com/dumko2001/deepagents/issues/1833)) ([1d1572e](https://github.com/dumko2001/deepagents/commit/1d1572e40cc9f87b97832cbe2b9152c281f8ec92))
* **cli:** detect deceptive unicode in tool args and URLs ([#1694](https://github.com/dumko2001/deepagents/issues/1694)) ([d4c8544](https://github.com/dumko2001/deepagents/commit/d4c8544bd6bf3b6df50b99f8a0c7208c20f86bd9))
* **cli:** dismiss completion dropdown on `esc` ([#1362](https://github.com/dumko2001/deepagents/issues/1362)) ([961b7fc](https://github.com/dumko2001/deepagents/commit/961b7fc764a7fbf63466d78c1d80b154b5d1692b))
* **cli:** display model name and context window size using `/tokens` ([#1441](https://github.com/dumko2001/deepagents/issues/1441)) ([ff7ef0f](https://github.com/dumko2001/deepagents/commit/ff7ef0f87e6dfc6c581edb34b1a57be7ff6e059c))
* **cli:** enable `ask_user` tool by default ([#1830](https://github.com/dumko2001/deepagents/issues/1830)) ([ed0c745](https://github.com/dumko2001/deepagents/commit/ed0c745eef8d8fad40aa39b0dfd4de2ba9988fe5))
* **cli:** enhance tool-call UI, add `Ctrl+U` shortcut for chat input ([#1757](https://github.com/dumko2001/deepagents/issues/1757)) ([800c552](https://github.com/dumko2001/deepagents/commit/800c55213aa4c6515759fb70d36af370feb86302))
* **cli:** expand local context & implement via bash for sandbox support ([#1295](https://github.com/dumko2001/deepagents/issues/1295)) ([de8bc7c](https://github.com/dumko2001/deepagents/commit/de8bc7cbbd7780ef250b3838f61ace85d4465c0a))
* **cli:** fuzzy search for slash command autocomplete ([#1660](https://github.com/dumko2001/deepagents/issues/1660)) ([5f6e9c0](https://github.com/dumko2001/deepagents/commit/5f6e9c014e6a99783b3113184cc12f0179a902f0))
* **cli:** make thread link clickable when switching ([#1296](https://github.com/dumko2001/deepagents/issues/1296)) ([9409520](https://github.com/dumko2001/deepagents/commit/9409520d524c576c3b0b9686c96a1749ee9dcbbb)), closes [#1291](https://github.com/dumko2001/deepagents/issues/1291)
* **cli:** mcp tool loading with auto-discovery ([#801](https://github.com/dumko2001/deepagents/issues/801)) ([df0908e](https://github.com/dumko2001/deepagents/commit/df0908ebed4e17f0fd904d83e9d4ea38dfc1207d))
* **cli:** model detail footer + persist `--profile-override` on hot-swap ([#1700](https://github.com/dumko2001/deepagents/issues/1700)) ([f2c8b54](https://github.com/dumko2001/deepagents/commit/f2c8b54e9b4c541bf6f91139bfb9b6a2f20c8de0))
* **cli:** rearrange HITL option order in approval menu ([#1726](https://github.com/dumko2001/deepagents/issues/1726)) ([0ca6cb2](https://github.com/dumko2001/deepagents/commit/0ca6cb237b6da538bad2b4bf292942c8db72ec1f))
* **cli:** refresh local context after summarization events ([#1384](https://github.com/dumko2001/deepagents/issues/1384)) ([dcb9583](https://github.com/dumko2001/deepagents/commit/dcb95839de360f03d2fc30c9144096874b24006f))
* **cli:** rework `/thread` switcher with search, columns, delete, and sort toggle ([#1723](https://github.com/dumko2001/deepagents/issues/1723)) ([8b21ddb](https://github.com/dumko2001/deepagents/commit/8b21ddb2ff7f13d6b3ffcbf2fe605bfbadbc3d38))
* **cli:** set openrouter headers, default to `gemini-3.1-pro-preview` ([#1455](https://github.com/dumko2001/deepagents/issues/1455)) ([95c0b71](https://github.com/dumko2001/deepagents/commit/95c0b71c2fafbec8424d92e7698563045a787866)), closes [#1454](https://github.com/dumko2001/deepagents/issues/1454)
* **cli:** show cli version in non-interactive header ([#1881](https://github.com/dumko2001/deepagents/issues/1881)) ([adacc3f](https://github.com/dumko2001/deepagents/commit/adacc3fd0a0f040373b8ef39032978019b5c8e5f))
* **cli:** show editable install source path in help and banner ([#1916](https://github.com/dumko2001/deepagents/issues/1916)) ([4ce1cee](https://github.com/dumko2001/deepagents/commit/4ce1ceebdd2e4aa6db008061519d3df1e422c2db))
* **cli:** show langsmith thread url on session teardown ([#1285](https://github.com/dumko2001/deepagents/issues/1285)) ([899fd1c](https://github.com/dumko2001/deepagents/commit/899fd1cdea6f7b2003992abd3f6173d630849a90))
* **cli:** show message timestamp toast on click ([#1702](https://github.com/dumko2001/deepagents/issues/1702)) ([4f403ec](https://github.com/dumko2001/deepagents/commit/4f403ecb3332010062158ec30fd55f349654a533))
* **cli:** show model status in `/model` selector ([#1820](https://github.com/dumko2001/deepagents/issues/1820)) ([92ce0cf](https://github.com/dumko2001/deepagents/commit/92ce0cffde6f49131541b5985bc80058ae0ad46e))
* **cli:** show platform-specific ripgrep install command in missing-tool warning ([#1997](https://github.com/dumko2001/deepagents/issues/1997)) ([f000ce5](https://github.com/dumko2001/deepagents/commit/f000ce58ebb6438397e8eb016b2a788a91fe5754))
* **cli:** show sdk version alongside cli version ([#1378](https://github.com/dumko2001/deepagents/issues/1378)) ([e99b4c8](https://github.com/dumko2001/deepagents/commit/e99b4c864afd01d68c3829304fb93cc0530eedee))
* **cli:** show summarization status and notification    ([#919](https://github.com/dumko2001/deepagents/issues/919)) ([2e3cb74](https://github.com/dumko2001/deepagents/commit/2e3cb743eff8e0a33b215359132cee13a673a4df))
* **cli:** strip mode-trigger prefix from chat input text ([#1373](https://github.com/dumko2001/deepagents/issues/1373)) ([6879eff](https://github.com/dumko2001/deepagents/commit/6879effb37c2160ef3835cd2d058b79f9d3a5a99))
* **cli:** support piped stdin as prompt input ([#1254](https://github.com/dumko2001/deepagents/issues/1254)) ([cca61ff](https://github.com/dumko2001/deepagents/commit/cca61ff5edb5e2424bfc54b2ac33b59a520fdd6a))
* **cli:** surface mcp server/tool info in system prompt ([#1693](https://github.com/dumko2001/deepagents/issues/1693)) ([068e075](https://github.com/dumko2001/deepagents/commit/068e075ecd4a7f3e35219ae6b87707bd9dc3f785))
* **cli:** tab autocomplete in model selector ([#1669](https://github.com/dumko2001/deepagents/issues/1669)) ([28bd0aa](https://github.com/dumko2001/deepagents/commit/28bd0aaca737b8bb194ecb9f6612989b9aacec02))
* **cli:** tailor system prompt for non-interactive mode ([#1727](https://github.com/dumko2001/deepagents/issues/1727)) ([871e5cf](https://github.com/dumko2001/deepagents/commit/871e5cf76b1a7e7cf7175b4415bb8e2206da39ec))
* **cli:** track and display working directory per thread ([#1735](https://github.com/dumko2001/deepagents/issues/1735)) ([0e4f25d](https://github.com/dumko2001/deepagents/commit/0e4f25dfbc3e15653bc3f8a6d32a0a61ead4ba82))
* **cli:** update system & default prompt ([#1293](https://github.com/dumko2001/deepagents/issues/1293)) ([2aeb092](https://github.com/dumko2001/deepagents/commit/2aeb092e027affd9eaa8a78b33101e1fd930d444))
* **cli:** warn when ripgrep is not installed ([#1337](https://github.com/dumko2001/deepagents/issues/1337)) ([0367efa](https://github.com/dumko2001/deepagents/commit/0367efa323b7a29c015d6a3fbb5af8894dc724b8))
* **cli:** windowed thread hydration and configurable thread limit ([#1435](https://github.com/dumko2001/deepagents/issues/1435)) ([9da8d0b](https://github.com/dumko2001/deepagents/commit/9da8d0b5c86441e87b85ee6f8db1d23848a823ed))
* **infra:** add fireworks as eval provider ([#1684](https://github.com/dumko2001/deepagents/issues/1684)) ([eb26f61](https://github.com/dumko2001/deepagents/commit/eb26f61cbceaeffef3414b402d28cac7af3e3a9a))
* **infra:** ensure dep group version match for CLI ([#1316](https://github.com/dumko2001/deepagents/issues/1316)) ([db05de1](https://github.com/dumko2001/deepagents/commit/db05de1b0c92208b9752f3f03fa5fa54813ab4ef))
* **sdk:** add async subagent middleware for remote LangGraph servers ([#1758](https://github.com/dumko2001/deepagents/issues/1758)) ([0c5d501](https://github.com/dumko2001/deepagents/commit/0c5d501066e7e9cb74737740d9b3c1dfc74751a6))
* **sdk:** add factory function for summarization tool middleware ([#1749](https://github.com/dumko2001/deepagents/issues/1749)) ([282b4c2](https://github.com/dumko2001/deepagents/commit/282b4c209bde73632392cd8453e9c7430a9cbef3))
* **sdk:** add MemoryAgentBench evaluation suite ([#1807](https://github.com/dumko2001/deepagents/issues/1807)) ([6a0763d](https://github.com/dumko2001/deepagents/commit/6a0763d301b6d66813f7168abc300243e0a4d1ea))
* **sdk:** add per-command `timeout` override to `execute()` ([#1154](https://github.com/dumko2001/deepagents/issues/1154)) ([49277d4](https://github.com/dumko2001/deepagents/commit/49277d45a026c86b5bf176142dcb1dfc2c7643ae))
* **sdk:** enable type checking in deepagents and resolve most linting issues ([#991](https://github.com/dumko2001/deepagents/issues/991)) ([5c90376](https://github.com/dumko2001/deepagents/commit/5c90376c02754c67d448908e55d1e953f54b8acd))
* **sdk:** port `LangSmithSandbox` from CLI to SDK ([#1983](https://github.com/dumko2001/deepagents/issues/1983)) ([dfff6e7](https://github.com/dumko2001/deepagents/commit/dfff6e7d2f91c269290ab677a9bd7454bc2f4989))
* **sdk:** rename backend methods ([#1907](https://github.com/dumko2001/deepagents/issues/1907)) ([7665066](https://github.com/dumko2001/deepagents/commit/7665066c093c2583c4cd3bf83515b0906277306f))
* **sdk:** update backend return types for ls, glob, grep ([#1870](https://github.com/dumko2001/deepagents/issues/1870)) ([23cf264](https://github.com/dumko2001/deepagents/commit/23cf264d0d9784cfce8f8720b125c6ed05a2e2c3))
* **sdk:** update FileData and backend.read return type to support multimodal data ([#1869](https://github.com/dumko2001/deepagents/issues/1869)) ([6fb4ede](https://github.com/dumko2001/deepagents/commit/6fb4ede894fe5333ea11598468e924442b3b48a7))


### Bug Fixes

* **cli,sdk:** harden path hardening ([#918](https://github.com/dumko2001/deepagents/issues/918)) ([fc34a14](https://github.com/dumko2001/deepagents/commit/fc34a144a2791c75f8b4c11f67dd1adbc029c81e))
* **cli:** add missing flags to help screen ([#1619](https://github.com/dumko2001/deepagents/issues/1619)) ([6067749](https://github.com/dumko2001/deepagents/commit/60677492b3f49adc8535b34156029271a0728923))
* **cli:** align compaction messaging across `/compact` and `compact_conversation` ([#1583](https://github.com/dumko2001/deepagents/issues/1583)) ([d455a6b](https://github.com/dumko2001/deepagents/commit/d455a6b117dbca2dfb5156050273a84946adc247))
* **cli:** allow Esc to exit command/bash input mode ([#1644](https://github.com/dumko2001/deepagents/issues/1644)) ([906da72](https://github.com/dumko2001/deepagents/commit/906da72ea40e16492f8e7f3c35758af486c92b3c))
* **cli:** anchor `ChatInput` below scrollable area ([#1671](https://github.com/dumko2001/deepagents/issues/1671)) ([11105d9](https://github.com/dumko2001/deepagents/commit/11105d93f593d802d5e120c095f16d771c674bef))
* **cli:** apply profile overrides in `/compact` ([#1612](https://github.com/dumko2001/deepagents/issues/1612)) ([a9dc2c5](https://github.com/dumko2001/deepagents/commit/a9dc2c5a1ad6d37f3f682491664b3f709cad8552))
* **cli:** auto-discover models for `class_path` providers ([#1816](https://github.com/dumko2001/deepagents/issues/1816)) ([177fe0f](https://github.com/dumko2001/deepagents/commit/177fe0f663926d6879aa2177b7988d45cd1e4055))
* **cli:** backspace at cursor position 0 exits mode even with text ([#1666](https://github.com/dumko2001/deepagents/issues/1666)) ([dfa4c1f](https://github.com/dumko2001/deepagents/commit/dfa4c1fedcecf2bb17d8ffef01cf50efe6c80fb0))
* **cli:** coerce execute timeout to int before formatting tool display ([#1588](https://github.com/dumko2001/deepagents/issues/1588)) ([04b8c72](https://github.com/dumko2001/deepagents/commit/04b8c72361f7eb60b86fa560ef3f6283912c3395)), closes [#1586](https://github.com/dumko2001/deepagents/issues/1586)
* **cli:** correct model selector footer showing wrong profile after search ([#1805](https://github.com/dumko2001/deepagents/issues/1805)) ([2f1d52f](https://github.com/dumko2001/deepagents/commit/2f1d52f4ad65add210d6f840b1b78e62eba37195))
* **cli:** disambiguate `/tokens` vs `/compact` token reporting ([#1618](https://github.com/dumko2001/deepagents/issues/1618)) ([51c3347](https://github.com/dumko2001/deepagents/commit/51c3347e5a402115d4ecbb09f0074c607270f992))
* **cli:** duplicate paste issue ([#1460](https://github.com/dumko2001/deepagents/issues/1460)) ([9177515](https://github.com/dumko2001/deepagents/commit/9177515c8a968882e980d229fb546c9753475de7)), closes [#1425](https://github.com/dumko2001/deepagents/issues/1425)
* **cli:** eliminate autocomplete popup flicker ([#2020](https://github.com/dumko2001/deepagents/issues/2020)) ([4b2db1e](https://github.com/dumko2001/deepagents/commit/4b2db1eab412ecfb1343fae123777f14e935fcea))
* **cli:** escape `Rich` markup in shell command display ([#1413](https://github.com/dumko2001/deepagents/issues/1413)) ([c330290](https://github.com/dumko2001/deepagents/commit/c33029032a1e2072dab2d06e93953f2acaa6d400))
* **cli:** escape dynamic strings in rich markup to prevent markup injection ([#1888](https://github.com/dumko2001/deepagents/issues/1888)) ([d349d10](https://github.com/dumko2001/deepagents/commit/d349d1061647325fdb4ea6322254b24555abf751))
* **cli:** expire `ctrl+c` quit window when toast disappears ([#1701](https://github.com/dumko2001/deepagents/issues/1701)) ([38b5ea9](https://github.com/dumko2001/deepagents/commit/38b5ea9484ab121c9b2919dd74469e82fce19b82))
* **cli:** fix stale model settings during model hot-swap ([#1257](https://github.com/dumko2001/deepagents/issues/1257)) ([55c119c](https://github.com/dumko2001/deepagents/commit/55c119cb6ce73db7cae0865172f00ab8fc9f8fc1))
* **cli:** forward `DAYTONA_API_URL` to avoid deprecated `server_url` access ([#1844](https://github.com/dumko2001/deepagents/issues/1844)) ([7d19ca8](https://github.com/dumko2001/deepagents/commit/7d19ca8e6404a2ea98aac6a9d4cae7a2b529922c))
* **cli:** handle `None` selection endpoint, `IndexError` in clipboard copy ([#1342](https://github.com/dumko2001/deepagents/issues/1342)) ([5754031](https://github.com/dumko2001/deepagents/commit/57540316cf928da3dcf4401fb54a5d0102045d67))
* **cli:** harden MCP pre-flight health checks ([#2019](https://github.com/dumko2001/deepagents/issues/2019)) ([2b27055](https://github.com/dumko2001/deepagents/commit/2b270558fcd846f9f82ffa2bc3b56810b5851d7d))
* **cli:** human-readable duration and consistent dim styling on teardown screen ([#1995](https://github.com/dumko2001/deepagents/issues/1995)) ([901a0a4](https://github.com/dumko2001/deepagents/commit/901a0a400fccfafbef069d6632acb2227f0aef41))
* **cli:** image path pasting qualms ([#1560](https://github.com/dumko2001/deepagents/issues/1560)) ([8caaf3e](https://github.com/dumko2001/deepagents/commit/8caaf3e71ae7f5a26c20ca86700cc51f3c6f37ed))
* **cli:** isolate test history writes from real history file ([#2006](https://github.com/dumko2001/deepagents/issues/2006)) ([a078257](https://github.com/dumko2001/deepagents/commit/a078257ba6f9d9cae540f6eb82a0eabc92d71211))
* **cli:** let unknown providers through credential check ([#1815](https://github.com/dumko2001/deepagents/issues/1815)) ([89d39de](https://github.com/dumko2001/deepagents/commit/89d39ded171bf300e9b17972f18063e9157f298f))
* **cli:** load `.agents` skill alias directories at interactive startup ([#1556](https://github.com/dumko2001/deepagents/issues/1556)) ([af0a759](https://github.com/dumko2001/deepagents/commit/af0a759ee231cfe8860da34fe39dbcff38726102))
* **cli:** load root-level `AGENTS.md` into agent system prompt ([#1445](https://github.com/dumko2001/deepagents/issues/1445)) ([047fa2c](https://github.com/dumko2001/deepagents/commit/047fa2cadfb9f005410c21a6e1e3b3d59eadda7d))
* **cli:** localize newline shortcut labels by platform ([#1721](https://github.com/dumko2001/deepagents/issues/1721)) ([f35576b](https://github.com/dumko2001/deepagents/commit/f35576bafac711d6c04f1f9dd40ec97a90e30060))
* **cli:** make `!` bash commands interruptible via `Esc`/`Ctrl+C` ([#1638](https://github.com/dumko2001/deepagents/issues/1638)) ([0c414d1](https://github.com/dumko2001/deepagents/commit/0c414d154a74cfabebfae8fc2dbb6d7e39da3857))
* **cli:** make escape reject pending HITL approval first ([#1645](https://github.com/dumko2001/deepagents/issues/1645)) ([5d7be0c](https://github.com/dumko2001/deepagents/commit/5d7be0c1a2fbe54f7fe062c5a43a7591aecb00e4))
* **cli:** make langsmith URL lookups non-blocking ([#1595](https://github.com/dumko2001/deepagents/issues/1595)) ([572eaee](https://github.com/dumko2001/deepagents/commit/572eaeefbe2f9318555733977e4771815879273c))
* **cli:** misleading "missing package" error when provider import fails ([#1960](https://github.com/dumko2001/deepagents/issues/1960)) ([b90fbad](https://github.com/dumko2001/deepagents/commit/b90fbad1335222a3b7ceb469f7f46fedec79ac61))
* **cli:** only exit input mode on backspace, not text clear ([#1479](https://github.com/dumko2001/deepagents/issues/1479)) ([da0965e](https://github.com/dumko2001/deepagents/commit/da0965ee33e6bdf7aec30865bed44a1bd38a7d12))
* **cli:** only navigate prompt history at input boundaries ([#1385](https://github.com/dumko2001/deepagents/issues/1385)) ([6d82d6d](https://github.com/dumko2001/deepagents/commit/6d82d6de290e73b897a58d724f3dfc7a32a06cba))
* **cli:** patch model identity in system prompt on `/model` swap ([#2024](https://github.com/dumko2001/deepagents/issues/2024)) ([36aecbf](https://github.com/dumko2001/deepagents/commit/36aecbf939cafb2d5914620a9e2ec890b02447a4))
* **cli:** persist models.recent on every session start ([#1802](https://github.com/dumko2001/deepagents/issues/1802)) ([32aa371](https://github.com/dumko2001/deepagents/commit/32aa371a371208146cc093c4e5eb7a752a74b3c9))
* **cli:** pre-flight health checks for MCP servers ([#2008](https://github.com/dumko2001/deepagents/issues/2008)) ([30d60e3](https://github.com/dumko2001/deepagents/commit/30d60e3866bde51a71f607fcd5cbe9dd75c5da75))
* **cli:** preserve input text when escaping shell/command mode ([#1706](https://github.com/dumko2001/deepagents/issues/1706)) ([3c00edb](https://github.com/dumko2001/deepagents/commit/3c00edb93eddf74e87d58526a02be72577ed65b1))
* **cli:** prevent `shift+enter` from sending `backslash+enter` ([#1728](https://github.com/dumko2001/deepagents/issues/1728)) ([81dceb0](https://github.com/dumko2001/deepagents/commit/81dceb043097a47702bb5a0227a8f12e9055bd05))
* **cli:** prevent crash when quitting with queued messages ([#1421](https://github.com/dumko2001/deepagents/issues/1421)) ([a3c9ae6](https://github.com/dumko2001/deepagents/commit/a3c9ae681501cd3efca82573a8d20a0dc8c9b338))
* **cli:** prevent cwd overflow in status bar when mode indicator is visible ([#1647](https://github.com/dumko2001/deepagents/issues/1647)) ([89717e2](https://github.com/dumko2001/deepagents/commit/89717e2e43c23703953bf0eb6d449135d0c93259))
* **cli:** prevent premature thinking state with parallel subtasks ([#1858](https://github.com/dumko2001/deepagents/issues/1858)) ([189104c](https://github.com/dumko2001/deepagents/commit/189104c622a5fa874ad1d4be1c18e012cafd605a))
* **cli:** prevent reentrant model switching ([#1824](https://github.com/dumko2001/deepagents/issues/1824)) ([09d16a8](https://github.com/dumko2001/deepagents/commit/09d16a8151466fd2d82976d44d7b4e957255bcd9))
* **cli:** remove dead chat-spacer widget and resize handler ([#1686](https://github.com/dumko2001/deepagents/issues/1686)) ([b6ecec5](https://github.com/dumko2001/deepagents/commit/b6ecec5bd14677a878c92a1b51e950f61fabf8d3))
* **cli:** remove double slash in skills path template ([#1808](https://github.com/dumko2001/deepagents/issues/1808)) ([2bc9620](https://github.com/dumko2001/deepagents/commit/2bc962075146548f2ef4c8851bd502df9d6a1fa5))
* **cli:** remove model fallback to env variables ([#1458](https://github.com/dumko2001/deepagents/issues/1458)) ([c9b4275](https://github.com/dumko2001/deepagents/commit/c9b4275e22fda5aa35b3ddce924277ec8aaa9e1f))
* **cli:** replace per-chunk `scroll_end` with anchor to fix scrollbar flicker ([#1891](https://github.com/dumko2001/deepagents/issues/1891)) ([a9be236](https://github.com/dumko2001/deepagents/commit/a9be2368509f9f2c66537014ae2138253cf0dc39))
* **cli:** resolve config-defined providers during runtime model swaps ([#1941](https://github.com/dumko2001/deepagents/issues/1941)) ([aebc660](https://github.com/dumko2001/deepagents/commit/aebc660321895909f6b6eb71e72a99ca7754bcf1))
* **cli:** retry langsmith project url lookup until project exists ([#1562](https://github.com/dumko2001/deepagents/issues/1562)) ([e137a63](https://github.com/dumko2001/deepagents/commit/e137a633fdadda205b8e05a9fdabc4b978726a37))
* **cli:** right-align token count next to model name in status bar ([#1705](https://github.com/dumko2001/deepagents/issues/1705)) ([311c919](https://github.com/dumko2001/deepagents/commit/311c9191cf663540e1b62eb9452abecda5bc7b4f))
* **cli:** show checkmark for `class_path` providers in model selector ([#1899](https://github.com/dumko2001/deepagents/issues/1899)) ([4adb712](https://github.com/dumko2001/deepagents/commit/4adb712c8eacbcfbc06801c31bfd74fc0705bed3))
* **cli:** show cwd on startup ([#1209](https://github.com/dumko2001/deepagents/issues/1209)) ([23032dd](https://github.com/dumko2001/deepagents/commit/23032ddd80b0ec8bf58c91776e62b834f6e03b5e))
* **cli:** show model info in `/tokens` before first usage ([#1607](https://github.com/dumko2001/deepagents/issues/1607)) ([7b01ae7](https://github.com/dumko2001/deepagents/commit/7b01ae7258ed079046262d1c174f1c406101294c))
* **cli:** skip auto-approve toggle when modal screen is open ([#1668](https://github.com/dumko2001/deepagents/issues/1668)) ([6597f0b](https://github.com/dumko2001/deepagents/commit/6597f0b8da3c3bd701a42e228660d459cefe3f64))
* **cli:** skip usage table when no model was called ([#1640](https://github.com/dumko2001/deepagents/issues/1640)) ([0a7db73](https://github.com/dumko2001/deepagents/commit/0a7db73a3edacd4d3689091248a87a9eaf709899))
* **cli:** slash commands should not require server connection / queue ([#1974](https://github.com/dumko2001/deepagents/issues/1974)) ([32bd814](https://github.com/dumko2001/deepagents/commit/32bd814b98a079778dad092a2e877d8eba22b0fb))
* **cli:** sort prefetched threads by user preference on initial render ([#1806](https://github.com/dumko2001/deepagents/issues/1806)) ([6f71153](https://github.com/dumko2001/deepagents/commit/6f711532976821a92e3396fe458ec7874b1237ef))
* **cli:** substitute image base64 for placeholder in result block ([#1381](https://github.com/dumko2001/deepagents/issues/1381)) ([54f4d8e](https://github.com/dumko2001/deepagents/commit/54f4d8e834c4aad672d78b4130cd43f2454424fa))
* **cli:** support space-separated tokens in model fuzzy search ([#1636](https://github.com/dumko2001/deepagents/issues/1636)) ([6179a96](https://github.com/dumko2001/deepagents/commit/6179a96400fb000298e0ed3ef7aa839e89fdffa5))
* **cli:** surface clear error for missing sandbox provider deps ([#1999](https://github.com/dumko2001/deepagents/issues/1999)) ([939f56a](https://github.com/dumko2001/deepagents/commit/939f56a19244714fc53158a2fd162e3098b3d56c))
* **cli:** terminate active subprocesses on app quit ([#1646](https://github.com/dumko2001/deepagents/issues/1646)) ([5f2e614](https://github.com/dumko2001/deepagents/commit/5f2e614f05912d3278a988cb7366612099105acf))
* **cli:** truncate model name in status bar on narrow terminals ([#1665](https://github.com/dumko2001/deepagents/issues/1665)) ([0e24a04](https://github.com/dumko2001/deepagents/commit/0e24a04aa9e5894735522ce23295bb27fd2b8190))
* **cli:** use `max-height` for `tool-info-scroll` to shrink-wrap content ([#1835](https://github.com/dumko2001/deepagents/issues/1835)) ([a4e1908](https://github.com/dumko2001/deepagents/commit/a4e1908527c3a30a6f967dd1d989739d540ddd2a))
* **cli:** use ascii-safe glyphs in tool status restore path ([#1895](https://github.com/dumko2001/deepagents/issues/1895)) ([2a9cbc8](https://github.com/dumko2001/deepagents/commit/2a9cbc8540b2ab77362cbb00764a3533e234891f))
* **cli:** use counter to close history-recall autocomplete race ([#1901](https://github.com/dumko2001/deepagents/issues/1901)) ([bfd08af](https://github.com/dumko2001/deepagents/commit/bfd08afbc0eca844e565842dff50eddb067e4750))
* **cli:** use first-class OpenRouter attribution kwargs ([#1635](https://github.com/dumko2001/deepagents/issues/1635)) ([9c1ed93](https://github.com/dumko2001/deepagents/commit/9c1ed93861a52b9ced2c1426131d542f50afa623))
* **cli:** use UUID7 for thread IDs instead of 8-char hex ([#1826](https://github.com/dumko2001/deepagents/issues/1826)) ([821885b](https://github.com/dumko2001/deepagents/commit/821885bab8ae2eef873a33fdaa6dc427a473d764))
* **cli:** work around VS Code 1.110 space key regression ([#1748](https://github.com/dumko2001/deepagents/issues/1748)) ([f5fe431](https://github.com/dumko2001/deepagents/commit/f5fe4315143bf5b636cf42fc98cbfe3d99918cfc))
* **cli:** write files with langsmith sandbox ([#1714](https://github.com/dumko2001/deepagents/issues/1714)) ([5933c9e](https://github.com/dumko2001/deepagents/commit/5933c9e2995c422e43649c61981e086ac1eaf725))
* **sdk,cli,deps:** support `timeout=0` for sandbox `execute()` ([#1558](https://github.com/dumko2001/deepagents/issues/1558)) ([ed14443](https://github.com/dumko2001/deepagents/commit/ed14443b5aec8afde1f74bb2e12a17cb7d1829b6))
* Unreachable `except` block ([#1535](https://github.com/dumko2001/deepagents/issues/1535)) ([0e17e35](https://github.com/dumko2001/deepagents/commit/0e17e352fa2ae4e34320a27d272586a10a0a7aec))


### Performance Improvements

* **cli:** add textual-speedups for Rust-based layout primitives ([#1910](https://github.com/dumko2001/deepagents/issues/1910)) ([45b58a1](https://github.com/dumko2001/deepagents/commit/45b58a13e14abfb58ef3688cee51a5819d8ca52d))
* **cli:** defer heavy imports ([#1361](https://github.com/dumko2001/deepagents/issues/1361)) ([dd992e4](https://github.com/dumko2001/deepagents/commit/dd992e48feb3e3a9fc6fd93f56e9d8a9cb51c7bf))
* **cli:** defer heavy imports from startup path ([#2022](https://github.com/dumko2001/deepagents/issues/2022)) ([b7f5a99](https://github.com/dumko2001/deepagents/commit/b7f5a99ecda2e3b795764e74bc1e9cbc405b7e18))
* **cli:** defer more heavy imports to speed up startup ([#1389](https://github.com/dumko2001/deepagents/issues/1389)) ([4dd10d5](https://github.com/dumko2001/deepagents/commit/4dd10d5c9f3cfe13cd7b9ac18a1799c0832976ff))
* **cli:** offload blocking path ops from textual event loop ([#1894](https://github.com/dumko2001/deepagents/issues/1894)) ([d3eedcc](https://github.com/dumko2001/deepagents/commit/d3eedccc7edd21103ca1e586fc365d721f674099))
* **cli:** optimize thread resume path with prefetch and batched hydration ([#1561](https://github.com/dumko2001/deepagents/issues/1561)) ([068d112](https://github.com/dumko2001/deepagents/commit/068d1128177de0f0a01f533a01184039c2a2f09f))
* **cli:** parallelize detect script for faster first-turn ([#1541](https://github.com/dumko2001/deepagents/issues/1541)) ([dad8b6e](https://github.com/dumko2001/deepagents/commit/dad8b6e15a78d26921c0cb831579648927caa551))
* **cli:** speed up `/model` selector with cache pre-warming and async saves ([#1813](https://github.com/dumko2001/deepagents/issues/1813)) ([2aec75c](https://github.com/dumko2001/deepagents/commit/2aec75c8dca6c0510671cf1288a924c4ca9bce1c))
* **cli:** speed up `/threads` first-open ([#1481](https://github.com/dumko2001/deepagents/issues/1481)) ([b248b15](https://github.com/dumko2001/deepagents/commit/b248b15fd70de3c4d055b68a0dae04f00e41ea9e))
* **cli:** speed up `/threads` modal startup ([#1811](https://github.com/dumko2001/deepagents/issues/1811)) ([5758df1](https://github.com/dumko2001/deepagents/commit/5758df1b663cd09726b8cd08d86897351142ed5e))
* **cli:** speed up unit tests in CI ([#1817](https://github.com/dumko2001/deepagents/issues/1817)) ([59b1b5c](https://github.com/dumko2001/deepagents/commit/59b1b5cb720a309434d7e863d2e45e83f8ac1432))
* **cli:** sub 250ms first paint ([#2027](https://github.com/dumko2001/deepagents/issues/2027)) ([e42e05c](https://github.com/dumko2001/deepagents/commit/e42e05c12229ece450746d6f943d2483477518a5))
* **cli:** use stream layout for messages container ([#1896](https://github.com/dumko2001/deepagents/issues/1896)) ([b35401b](https://github.com/dumko2001/deepagents/commit/b35401b885a7651db548f1826ddb24476ecde5b7))


### Reverted Changes

* make summarization test compatible with sdk 0.4.11 ([#1923](https://github.com/dumko2001/deepagents/issues/1923)) ([22fd479](https://github.com/dumko2001/deepagents/commit/22fd4793196f3b2493ed155330ec325302b6e960))
